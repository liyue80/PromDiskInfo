...
public:
    ...
    struct ATA_SMART_INFO
    {
        ...
        inline bool operator< (const ATA_SMART_INFO &p2)
        {
            if (PhysicalDriveId == -1 && p2.PhysicalDriveId == -1)
            {
                return sasPhyEntity.bPortIdentifier - p2.sasPhyEntity.bPortIdentifier;
            }
            else
            {
                return PhysicalDriveId - p2.PhysicalDriveId;
            }
        }
    };
    ...
    C_Array<ATA_SMART_INFO> vars;

    //CArray<EXTERNAL_DISK_INFO, EXTERNAL_DISK_INFO> externals;
    C_Array<EXTERNAL_DISK_INFO> externals;
    ...
    C_Array<DWORD> m_SiliconImageControllerType;
    //CArray<INT, INT> m_BlackPhysicalDrive;
    C_Array<INT> m_BlackPhysicalDrive;
